...
import { fetchEntityByIdentifier, fetchCompanyByCIN, checkCompanyDataStatus, triggerProbe42Update, getProbe42UpdateStatus } from "@/lib/probe42";
import { sendLeadAssignmentEmail, getAppBaseUrl, sendClientCredentialsEmail } from "@/lib/email";
...
/**
 * Send client portal access credentials via email
 */
